...
const MESSAGE_DUPLICATE_QUESTION_PAPER_SUCCESS =
  "Duplicate Question papers created successfully";
...
const MESSAGE_QUESTION_PAPER_TAKEN =
  "Question paper already exist. Please try a different one.";
const MESSAGE_QUESTION_PAPER_QUESTION_NUMBER_DUPLICATION =
...
const MESSAGE_QUESTION_PAPER_SECTIONS_NOT_FOUND =
  "One or more of the section listed are not valid";
...
const MESSAGE_EXAM_EXIST = "Exam already exist. Please try a different one";
const MESSAGE_CREATE_EXAMS_SUCCESS = "Exam created successfully";
const MESSAGE_UPDATE_EXAMS_SUCCESS = "Exam updated successfully";
const MESSAGE_DELETE_EXAMS_SUCCESS = "Exam deleted successfully";
const MESSAGE_DELETE_EXAMS_ERROR = "Couldn't delete the exam";
const MESSAGE_EXAM_NOT_ALLOWED_DELETE_REFERENCE_EXIST =
  "The selected exam is in use and not allowed to be deleted.";
